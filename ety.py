...
def online_ety_single(word):
    ...
    if page.find("section", class_="word__defination--2q7ZH undefined"):
        ...
        print(
            page.find("section",
                      class_="word__defination--2q7ZH undefined").get_text())
...
def online_ety(word):
    ...
    if page.find("section", class_="word__defination--2q7ZH undefined"):
        nameList = page.find_all(
            "a", class_="word__name--TTbAA word_thumbnail__name--1khEg")
        etyList = page.find_all("section",
                                class_="word__defination--2q7ZH undefined")
